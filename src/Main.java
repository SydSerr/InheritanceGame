...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        investigation.addChoice(new Choice("2. Check back door", new Outcome("It looks like it’s locked, bolted and boarded up. Maybe there’s tools around the house that can help unlock the door...", "return"), new Outcome("You pry off the boards, remove the bolts, and open the padlock, and pull it open...", "ending", "redkey", "bolt", "pry")));
        ...
        investigation.addChoice(new Choice("4. Check the garage", new Outcome("You open the door leading to the garage...", "nextScene2")));
