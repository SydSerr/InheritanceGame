...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        investigation.setStoryText("The key unlocks the door, giving you access to the rest of the house. You need to find a way out. Maybe look around?");
        ...
        garage.addChoice(new Choice("1. Check the metal chest",new Outcome("You find an old wrench in one of the drawers.Maybe you can use it to break or open something?","gainItem",wrench,"return")));
